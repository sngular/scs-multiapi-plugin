...
public class ClasspathTemplateLoader implements TemplateLoader {
  ...
  private final static List<String> templateAuthFiles = List.of(TEMPLATE_API_KEY,TEMPLATE_AUTHENTICATION,TEMPLATE_HTTP_BASIC,TEMPLATE_HTTP_BEARER,TEMPLATE_OAUTH,TEMPLATE_OAUTH_FLOW);
