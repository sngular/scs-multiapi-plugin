...
public class MapperContentUtil {
  ...
  private static List<String> getImportList(
      final Set<SchemaFieldObject> fieldObjectList, final String modelPackage) {
    ...
    for (final var fieldObject : fieldObjectList) {
      ...
      if (StringUtils.isNotBlank(fieldObject.getImportClass())
        ...
        listHashMap.put(
            StringUtils.capitalize(fieldObject.getImportClass()),
  ...
  private static void getTypeImports(
      final HashMap<String, List<String>> listHashMap, final SchemaFieldObject fieldObject) {
    ...
    if (type.containsType(TypeConstants.ARRAY)) {
      listHashMap.computeIfAbsent(
          TypeConstants.ARRAY, key -> List.of("java.util.List", "java.util.ArrayList"));
    }

    if (type.containsType(TypeConstants.MAP)) {
      listHashMap.computeIfAbsent(
          TypeConstants.MAP, key -> List.of("java.util.Map", "java.util.HashMap"));
    }
  ...
  private static Set<SchemaFieldObject> getFields(
    ...
    if (ApiTool.hasProperties(schema)) {
      ...
      final String itemType =
          ApiTool.hasRef(ApiTool.getItems(schema))
              ? MapperUtil.getRef(ApiTool.getItems(schema), operationParameter)
      ...
      fieldObjectArrayList.add(
          SchemaFieldObject.builder()
              ...
              .dataType(
                  new SchemaFieldObjectType(MapperUtil.getSimpleType(schema, operationParameter)))
              .build());
    }
    ...
    if (TypeConstants.ARRAY.equalsIgnoreCase(ApiTool.getType(schema))) {
      ...
      fieldObjectArrayList.add(
          processRef(
              fieldName,
              schema,
              new SchemaFieldObjectType(MapperUtil.getSimpleType(schema, specFile)),
              totalSchemas,
              compositedSchemas,
              antiLoopList,
              specFile));
      ...
      fieldObjectArrayList.add(
          processEnumField(fieldName, schema, specFile, ApiTool.getEnumValues(schema), schema));
      ...
      if (Objects.isNull(schemaObjectComposed)) {
        schemaObjectComposed =
            createComposedSchema(
                buildingSchema,
                StringUtils.defaultIfBlank(className, fieldName),
                schema,
                specFile,
                totalSchemas,
                compositedSchemas,
          ...
          SchemaFieldObject.builder()
              ...
              .dataType(
                  SchemaFieldObjectType.fromTypeList(
                      schemaObjectComposed.getClassName(), schemaObjectComposed.getClassName()))
              .build());
    }
  ...
  private static List<SchemaFieldObject> processObjectProperty(
    ...
    if (ApiTool.hasRef(fieldBody)) {
      ...
      if (!antiLoopList.contains(typeName)
              && totalSchemas.containsKey(typeName)
              && ApiTool.hasType(refSchema)
              && ApiTool.hasItems(refSchema)
          || ApiTool.getRefValue(fieldBody).contains(fieldName)) {
        ...
        fieldObjectArrayList.add(
            processEnumField(
                fieldName, refSchema, specFile, ApiTool.getEnumValues(refSchema), schema));
      } else {
        fieldObjectArrayList.add(
            SchemaFieldObject.builder()
                .baseName(fieldName)
                ...
                .dataType(
                    SchemaFieldObjectType.fromTypeList(
                        MapperUtil.getSimpleType(refSchema, specFile),
  ...
  private static SchemaFieldObject processStringProperty(
      final String propertyName, final JsonNode schema, final OperationParameter specFile) {
      ...
      if (ApiTool.hasRef(items)) {
        fieldObjectArrayList.add(
            processRef(
                ...
                items,
                SchemaFieldObjectType.fromTypeList(
                    TypeConstants.ARRAY, MapperUtil.getSimpleType(items, operationParameter)),
                totalSchemas,
                compositedSchemas,
                antiLoopList,
                operationParameter));
        ...
        fieldObjectArrayList.add(
            SchemaFieldObject.builder()
                ...
                .dataType(
                    SchemaFieldObjectType.fromTypeList(
                        TypeConstants.ARRAY, schemaObjectComposed.getClassName()))
        ...
        fieldObjectArrayList.add(
            SchemaFieldObject.builder()
                ...
                .dataType(
                    SchemaFieldObjectType.fromTypeList(
                        TypeConstants.ARRAY, MapperUtil.getPojoName(fieldName, operationParameter)))
                .build());
      } else {
        final SchemaFieldObject field =
            SchemaFieldObject.builder()
    ...
    if (ObjectUtils.allNull(className, fieldName)) {
      ...
      fieldObjectArrayList.add(
          SchemaFieldObject.builder()
              ...
              .dataType(
                  SchemaFieldObjectType.fromTypeList(
                      TypeConstants.OBJECT, MapperUtil.getPojoName(className, specFile)))
              .build());
      ...
      fieldObjectArrayList.add(
          SchemaFieldObject.builder()
              ...
              .dataType(
                  SchemaFieldObjectType.fromTypeList(
                      TypeConstants.OBJECT, MapperUtil.getPojoName(fieldName, specFile)))
              .build());
    } else {
      ...
      fieldObjectArrayList.add(
          SchemaFieldObject.builder()
              ...
              .dataType(
                  SchemaFieldObjectType.fromTypeList(
                      TypeConstants.OBJECT, MapperUtil.getPojoName(name, specFile)))
              .build());
    }
  ...
  private static List<SchemaFieldObject> processAdditionalProperties(
    ...
    if (TypeConstants.isBoolean(addPropObj.asText())) {
      ...
      final String refSchemaName = MapperUtil.getRef(addPropObj, operationParameter);
      fieldObjectArrayList.add(
          processRef(
              fieldName,
              addPropObj,
              SchemaFieldObjectType.fromTypeList(TypeConstants.MAP, refSchemaName),
              totalSchemas,
              compositedSchemas,
              antiLoopList,
              operationParameter));
          ...
          SchemaFieldObject.builder()
              ...
              .dataType(
                  SchemaFieldObjectType.fromTypeList(
                      TypeConstants.MAP,
                      TypeConstants.ARRAY,
                      MapperUtil.getSimpleType(ApiTool.getItems(addPropObj), operationParameter)))
              .build());
      ...
      fieldObjectArrayList.add(
          SchemaFieldObject.builder()
              ...
              .dataType(
                  SchemaFieldObjectType.fromTypeList(
                      TypeConstants.MAP,
                      MapperUtil.getPojoName(nameSchema + "Value", operationParameter)))
              .build());
    } else {
      final String type =
          isBasicType(addPropObj)
              ? MapperUtil.getSimpleType(addPropObj, operationParameter)
              : MapperUtil.getPojoName(
                  ApiTool.getName(schema) + ADDITIONAL_PROPERTY_NAME, operationParameter);
      fieldObjectArrayList.add(
          SchemaFieldObject.builder()
              .baseName(fieldName)
  ...
  private static boolean isBasicType(final JsonNode value) {
    return !(ApiTool.isObject(value)
        || ApiTool.isArray(value)
        || ApiTool.isComposed(value)
  ...
  private static String getMapTypeObject(final JsonNode schema, final OperationParameter specFile) {
    final String type;
  ...
  private static SchemaFieldObject processEnumField(
    ...
    final var dataType = MapperUtil.getSimpleType(value, operationParameter);
