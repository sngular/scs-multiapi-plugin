...
public class TestApi {
  ...
  public ResponseEntity<ApiTestDTO> listTestWithHttpInfo() throws RestClientException {
    ...
    return apiRestClient.invokeAPI(basePath,"/test", HttpMethod.GET, uriVariables, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
  }
  ...
  public ResponseEntity<ApiTestInfoDTO> showTestByIdWithHttpInfo(Integer testId, LocalDateTime pathVariableDate, LocalDateTime QueryParamDate) throws RestClientException {
    ...
    return apiRestClient.invokeAPI(basePath,"/test/{testId}", HttpMethod.GET, uriVariables, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
  }
  ...
  public ResponseEntity<Void> deleteTestByIdWithHttpInfo(Integer testId) throws RestClientException {
    ...
    return apiRestClient.invokeAPI(basePath,"/test/{testId}", HttpMethod.DELETE, uriVariables, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
  }
