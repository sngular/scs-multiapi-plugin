...
public interface V1Api {
  ...
  default ResponseEntity<List<CompanyDTO>> getCompanyInfo(@Parameter(name = "countryCode", description = "Country code according to ISO 3166", required = true, schema = @Schema(description = "")) @RequestParam(name = "countryCode", required = true) String countryCode , @Parameter(name = "vatCode", description = "The unique VAT code that identifies the company", required = true, schema = @Schema(description = "")) @RequestParam(name = "vatCode", required = true) String vatCode , @Parameter(name = "companyId", description = "The company database identifier", required = true, schema = @Schema(description = "")) @PathVariable("companyId") Integer companyId) {
