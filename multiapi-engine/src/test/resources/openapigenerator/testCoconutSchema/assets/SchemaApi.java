...
public interface SchemaApi {
  ...
  default ResponseEntity<SchemaDTO> getSchema(@Parameter(name = "name", description = "Schema name to get", required = true, schema = @Schema(description = "")) @PathVariable("name") String name) {
    return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
  }
  /**
   * PUT /schema/{name}
