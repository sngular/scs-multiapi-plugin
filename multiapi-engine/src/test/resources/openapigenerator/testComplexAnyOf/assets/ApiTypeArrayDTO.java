...
public class ApiTypeArrayDTO {
  ...
  private ApiTypeArrayDTO(Integer precision, ApiDefaultItemDTO defaultItem, Integer maximum, String type, Integer scale, Integer minLength, ApiSequenceFieldDTO sequenceField, String keyType, List<String> requiredValues, Boolean optionalUnion, Boolean flagExclusiveMinimum, Boolean flagExclusiveMaximum, Boolean defaultValue, List<String> enumValues, List<String> properties, List<String> defaultValues, UnionEnum unionEnum, Integer arraySize, Integer multipleOf, Integer mapSize, List<ApiTypeArrayDTO> mapTypes, Integer format, Boolean generatedFlag, Integer maxLength, Boolean uniqueItems, String name, String regex, Integer minItems, List<ApiTypeArrayDTO> values, Integer minimum, NumberEnum numberEnum, Integer valueLength) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(precision, defaultItem, maximum, type, scale, minLength, sequenceField, keyType, requiredValues, optionalUnion, flagExclusiveMinimum, flagExclusiveMaximum, defaultValue, enumValues, properties, defaultValues, unionEnum, arraySize, multipleOf, mapSize, mapTypes, format, generatedFlag, maxLength, uniqueItems, name, regex, minItems, values, minimum, numberEnum, valueLength);
  }
