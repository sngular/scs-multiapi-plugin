...
public class AsyncApiGeneratorFixtures {
  ...
  static final List<SpecFile> TEST_FILE_GENERATION = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testFileGeneration/event-api.yml")
  ...
  static final List<SpecFile> TEST_FILE_GENERATION_NO_CONFIG = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testFileGenerationNoConfiguration/event-api.yml")
      .build()
  );
  ...
  static final List<SpecFile> TEST_ISSUE_GENERATION = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testIssueGeneration/event-api.yml")
      .consumer(OperationParameterObject.builder()
        .ids("response")
        .modelNameSuffix("DTO")
  ...
  static final List<SpecFile> TEST_ISSUE_SIMPLE_TYPE_GENERATION = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testIssueSimpleTypeGeneration/event-api.yml")
      .consumer(OperationParameterObject.builder()
        .ids("response")
        .modelNameSuffix("DTO")
  ...
  static final List<SpecFile> TEST_RESERVED_WORDS_GENERATION = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testReservedWordsGeneration/event-api.yml")
      .consumer(OperationParameterObject.builder()
        .ids("subscribeOperationFileGeneration")
        .modelNameSuffix("DTO")
  ...
  static final List<SpecFile> TEST_RARE_CHARS_GENERATION = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testRareCharsGeneration/event-api.yml")
      .consumer(OperationParameterObject.builder()
        .ids("subscribeOperationFileGeneration")
        .modelNameSuffix("DTO")
  ...
  static final List<SpecFile> TEST_CUSTOM_VALIDATORS = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testCustomValidators/event-api.yml")
      .consumer(OperationParameterObject.builder()
  ...
  static final List<SpecFile> TEST_FILE_GENERATION_ISSUE = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testFileGenerationIssue/event-api.yml")
      .consumer(OperationParameterObject.builder()
        .ids("onCustomerEvent")
        .classNamePostfix("TestClassName")
        .modelNameSuffix("DTO")
  ...
  static final List<SpecFile> TEST_FILE_GENERATION_EXTERNAL_AVRO = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testFileGenerationExternalAvro/event-api.yml")
      .consumer(OperationParameterObject.builder()
  ...
  static final List<SpecFile> TEST_ISSUE_INVALID_AVRO = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testIssueInvalidAvro/event-api.yml")
      .consumer(OperationParameterObject.builder()
  ...
  static final List<SpecFile> TEST_FILE_GENERATION_STREAM_BRIDGE = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testFileGenerationStreamBridge/event-api.yml")
      .consumer(OperationParameterObject.builder()
  ...
  static final List<SpecFile> TEST_FILE_GENERATION_WITHOUT_IDS = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testFileGenerationWithoutOperationIds/event-api.yml")
      .consumer(OperationParameterObject.builder()
        .classNamePostfix("TestClassName")
        .modelNameSuffix("DTO")
  ...
  static final List<SpecFile> TEST_FILE_GENERATION_WITH_ARRAY_STRING = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testFileGenerationArrayString/event-api.yml")
      .supplier(OperationParameterObject.builder()
        .modelNameSuffix("DTO")
  ...
  static final List<SpecFile> TEST_ISSUE_GENERATE_SUPPLIER = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testIssueGenerateSupplier/event-api.yml")
      .supplier(OperationParameterObject.builder()
        .modelNameSuffix("DTO")
  ...
  static final List<SpecFile> TEST_ISSUE_INFINITE_LOOP = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testIssueInfiniteLoop/event-api.yml")
      .supplier(OperationParameterObject.builder()
        .modelNameSuffix("DTO")
  ...
  static final List<SpecFile> TEST_MODEL_CLASS_EXCEPTION_GENERATION = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testModelClassExceptionGeneration/event-api.yml")
      .consumer(OperationParameterObject.builder()
        .ids("subscribeOrder")
        .modelNameSuffix("DTO")
  ...
  static final List<SpecFile> TEST_GENERATION_WITH_NO_OPERATION_ID = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testGenerationWithNoOperationId/event-api.yml")
      .consumer(OperationParameterObject.builder()
        .modelNameSuffix("DTO")
  ...
  static final List<SpecFile> TEST_NO_SCHEMAS = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testNoSchemas/event-api.yml")
      .supplier(OperationParameterObject.builder()
        .modelNameSuffix("")
  ...
  static final List<SpecFile> TEST_MESSAGE_NAMING = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testMessageNaming/event-api.yml")
      .supplier(OperationParameterObject.builder()
        .modelNameSuffix("")
  ...
  static final List<SpecFile> TEST_NESTED_OBJECT = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testNestedObjectIssue/event-api.yml")
      .consumer(OperationParameterObject.builder()
        .modelNameSuffix("")
  ...
  static final List<SpecFile> TEST_CONSTANT_GENERATION = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testConstantGeneration/event-api.yml")
      .consumer(OperationParameterObject.builder()
        .modelNameSuffix("")
  ...
  static final List<SpecFile> PROPERTIES_NOT_GENERATED_ISSUE = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testPropertiesNotGeneratedIssue/event-api.yml")
      .consumer(OperationParameterObject.builder()
        .modelNameSuffix("")
  ...
  static final List<SpecFile> TEST_FILE_GENERATION_WITH_KAFKA_BINDINGS = List.of(
    SpecFile
      .builder()
      .filePath("asyncapigenerator/v3/testFileGenerationWithKafkaBindings/event-api.yml")
      .consumer(OperationParameterObject.builder()
  ...
  static final List<SpecFile> TEST_SUB_OBJECT_SAME_NAME =
    List.of(
      SpecFile.builder()
        .filePath("asyncapigenerator/v3/testSubObjectSameName/event-api.yml")
        .consumer(
  ...
  static final List<SpecFile> TEST_REFERENCE_FROM_LOCAL_ISSUE =
    List.of(
      SpecFile.builder()
        .filePath("asyncapigenerator/v3/testReferenceFromLocalIssue/event-api.yml")
        .consumer(
          OperationParameterObject.builder()
            .ids("userSignedUp")
  ...
  static Function<Path, Boolean> validateTestFileGeneration() {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testFileGeneration/";
  ...
  static Function<Path, Boolean> validateTestIssueGeneration() {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testIssueGeneration/";
  ...
  static Function<Path, Boolean> validateTestIssueSimpleTypeGeneration() {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testIssueSimpleTypeGeneration/";
  ...
  static Function<Path, Boolean> validateTestReservedWordsGeneration() {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testReservedWordsGeneration/";
  ...
  static Function<Path, Boolean> validateTestRareCharsGeneration() {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testRareCharsGeneration/";
  ...
  static Function<Path, Boolean> validateCustomValidators(final int springBootVersion) {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testCustomValidators/";
  ...
  static Function<Path, Boolean> validateTestFileGenerationIssue() {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testFileGenerationIssue/";
  ...
  static Function<Path, Boolean> validateTestFileGenerationExternalAvro() {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testFileGenerationExternalAvro/";
  ...
  static Function<Path, Boolean> validateTestFileGenerationStreamBridge() {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testFileGenerationStreamBridge/";
    ...
    final List<String> expectedConsumerFiles = List.of(
      ASSETS_PATH + "consumer/" + "ISubscribeOperationStreamBridge.java",
  ...
  static Function<Path, Boolean> validateTestFileGenerationWithoutIds() {
    ...
    final String DEFAULT_COMMON_FOLDER = "generated/com/sngular/scsplugin/withoutids/model/event";

    final String DEFAULT_CONSUMER_FOLDER = DEFAULT_COMMON_FOLDER + "/consumer";

    final String DEFAULT_PRODUCER_FOLDER = DEFAULT_COMMON_FOLDER + "/producer";

    final String COMMON_PATH = "asyncapigenerator/v3/testFileGenerationWithoutOperationIds/";
  ...
  static Function<Path, Boolean> validateTestFileGenerationArrayString() {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testFileGenerationArrayString/";
  ...
  static Function<Path, Boolean> validateTestIssueGenerateSupplier() {
    ...
    final List<String> expectedModelSchemaFiles = List.of(
      "asyncapigenerator/v3/testIssueGenerateSupplier/assets/ConfigurationDTO.java",
      "asyncapigenerator/v3/testIssueGenerateSupplier/assets/MailRequestDTO.java"
    );
  ...
  static Function<Path, Boolean> validateTestIssueInfiniteLoop() {
    ...
    final List<String> expectedModelSchemaFiles = List.of(
      "asyncapigenerator/v3/testIssueInfiniteLoop/assets/ConfigDTO.java",
      "asyncapigenerator/v3/testIssueInfiniteLoop/assets/MailRequestInfiniteDTO.java"
    );
  ...
  static Function<Path, Boolean> validateTestModelClassExceptionGeneration() {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testModelClassExceptionGeneration/";
  ...
  static Function<Path, Boolean> validateNoSchemas() {
    ...
    final List<String> expectedModelSchemaFiles = List.of(
      "asyncapigenerator/v3/testNoSchemas/assets/TestMsg.java",
      "asyncapigenerator/v3/testNoSchemas/assets/Thing.java"
    );

    final List<String> expectedProducerFiles = List.of(
      "asyncapigenerator/v3/testNoSchemas/assets/IOnTest.java",
      "asyncapigenerator/v3/testNoSchemas/assets/IOnTest2.java",
      "asyncapigenerator/v3/testNoSchemas/assets/Producer.java"
    );
  ...
  static Function<Path, Boolean> validateMessageNaming() {
    ...
    final List<String> expectedModelSchemaFiles = List.of(
      "asyncapigenerator/v3/testMessageNaming/assets/TestMsg.java",
      "asyncapigenerator/v3/testMessageNaming/assets/TestMsg2.java",
      "asyncapigenerator/v3/testMessageNaming/assets/TestMsg3.java"
    );

    final List<String> expectedProducerFiles = List.of(
      "asyncapigenerator/v3/testMessageNaming/assets/IOnTest.java",
      "asyncapigenerator/v3/testMessageNaming/assets/IOnTest2.java",
      "asyncapigenerator/v3/testMessageNaming/assets/IOnTest3.java",
      "asyncapigenerator/v3/testMessageNaming/assets/Producer.java"
    );
  ...
  static Function<Path, Boolean> validateNestedObject() {
    ...
    final List<String> expectedModelSchemaFiles = List.of(
      "asyncapigenerator/v3/testNestedObjectIssue/assets/payload/SomeOtherObject.java",
      "asyncapigenerator/v3/testNestedObjectIssue/assets/payload/UserSignedUpPayload.java"
    );
  ...
  static Function<Path, Boolean> validateConstantGeneration() {
    ...
    final List<String> expectedModelSchemaFiles = List.of(
      "asyncapigenerator/v3/testConstantGeneration/assets/payload/SomeOtherObject.java",
      "asyncapigenerator/v3/testConstantGeneration/assets/payload/UserSignedUpPayload.java"
    );
  ...
  static Function<Path, Boolean> validateNotGeneratedPropertiesIssue() {
    ...
    final List<String> expectedModelSchemaFiles = List.of(
      "asyncapigenerator/v3/testPropertiesNotGeneratedIssue/assets/payload/UserDetails.java",
      "asyncapigenerator/v3/testPropertiesNotGeneratedIssue/assets/payload/UserSignedUp.java"
    );
  ...
  static Function<Path, Boolean> validateTestFileGenerationWithKafkaBindings() {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testFileGenerationWithKafkaBindings/";
  ...
  static Function<Path, Boolean> validateTestSubObjectSameName() {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testSubObjectSameName/";
  ...
  static Function<Path, Boolean> validateTestReferenceFromLocalIssue() {
    ...
    final String COMMON_PATH = "asyncapigenerator/v3/testReferenceFromLocalIssue/";
