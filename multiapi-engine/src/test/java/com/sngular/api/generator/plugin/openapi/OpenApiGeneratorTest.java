  ...
  static Stream<Arguments> fileSpecToProcess() {
    return Stream.of(
        ...
        Arguments.of("testRequestBodyRequired_reactive", OpenApiGeneratorFixtures.TEST_REQUEST_BODY_REQUIRED_REACTIVE,
            OpenApiGeneratorFixtures.validateRequestBodyRequired("requestbodyrequiredreactive", "reactive")),
        Arguments.of("testRequestBodyRequired_restclient", OpenApiGeneratorFixtures.TEST_REQUEST_BODY_REQUIRED_REST_CLIENT,
            OpenApiGeneratorFixtures.validateRequestBodyRequired("requestbodyrequiredrestclient", "restclient")),
        Arguments.of("testRequestBodyRequired_webclient", OpenApiGeneratorFixtures.TEST_REQUEST_BODY_REQUIRED_WEB_CLIENT,
            OpenApiGeneratorFixtures.validateRequestBodyRequired("requestbodyrequiredwebclient", "webclient")),
        ...
        Arguments.of("testQueryObjectsClient", OpenApiGeneratorFixtures.TEST_QUERY_OBJECTS_CLIENT,
            OpenApiGeneratorFixtures.validateQueryObjectsClient()),
        Arguments.of("testCamelCaseNames", OpenApiGeneratorFixtures.TEST_CAMEL_CASE_NAMES,
            OpenApiGeneratorFixtures.validateCamelCaseNames()),
