...
class AsyncApiGeneratorJakartaTest {
  ...
  static void setup() {
    asyncApiGenerator =
        new AsyncApiGenerator(SPRING_BOOT_VERSION, new File(baseDir.toAbsolutePath() + File.separator + AsyncApiGeneratorFixtures.TARGET), AsyncApiGeneratorFixtures.GENERATED, "groupId",
                              baseDir.toFile());
  }
